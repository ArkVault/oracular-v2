...
const messages = {
  en: {
    'nav.primary': 'Primary navigation', 'nav.dates': 'Dates', 'nav.sensors': 'Sensors', 'nav.guide': 'Guide', 'nav.guideOn': 'Turn on workflow guide', 'nav.guideOff': 'Turn off workflow guide', 'nav.search': 'Search', 'nav.notifications': 'Notifications', 'nav.account': 'Account',
    ...
    'guide.label': 'Workflow guide', 'guide.previous': 'Previous step', 'guide.dismiss': 'Dismiss workflow guide', 'guide.step1': 'Step 1 of 4', 'guide.searchTitle': 'Search for a place', 'guide.searchDescription': 'Find and select the coast, lake, city, or landscape you want to analyze.', 'guide.openSearch': 'Open Search', 'guide.step2': 'Step 2 of 4', 'guide.dateTitle': 'Choose an acquisition date', 'guide.dateDescription': 'Open Dates and select a highlighted day with available satellite imagery.', 'guide.openDates': 'Open Dates', 'guide.step3': 'Step 3 of 4', 'guide.indicatorTitle': 'Choose an indicator', 'guide.indicatorDescription': 'Select an analysis from the left panel. The demo allows 1 analysis per indicator and IP address in each rolling 24-hour window. Using one indicator does not consume another. Natural Color, search, and date selection do not count.', 'guide.step4': 'Step 4 of 4', 'guide.readyTitle': 'Ready to go', 'guide.readyDescription': 'Your indicator is applied. Explore the map or click any water body to inspect the result.', 'guide.ready': 'Ready to go', 'guide.search': 'Search', 'guide.dates': 'Dates', 'guide.indicators': 'Indicators', 'guide.readyShort': 'Ready',
    'access.title': 'Developer access', 'access.description': 'Sign in with the private developer passphrase to run unlimited tests on this browser.', 'access.passphrase': 'Developer passphrase', 'access.signIn': 'Enable unlimited testing', 'access.signOut': 'End developer session', 'access.active': 'Unlimited developer testing is active.', 'access.invalid': 'The passphrase is invalid or developer access is unavailable.', 'access.close': 'Close developer access',
    'limit.demoBadge': 'Demo · 1 analysis per indicator / 24h per IP', 'limit.reached': 'This indicator was already used from this IP. Try again after {time}.', 'limit.unavailable': 'Unable to verify the analysis allowance. Please try again.', 'loader.analysis': 'Analyzing satellite data',
  ...
  es: {
    'nav.primary': 'Navegación principal', 'nav.dates': 'Fechas', 'nav.sensors': 'Sensores', 'nav.guide': 'Guía', 'nav.guideOn': 'Activar guía de flujo', 'nav.guideOff': 'Desactivar guía de flujo', 'nav.search': 'Buscar', 'nav.notifications': 'Notificaciones', 'nav.account': 'Cuenta',
    ...
    'guide.label': 'Guía de flujo', 'guide.previous': 'Paso anterior', 'guide.dismiss': 'Cerrar guía de flujo', 'guide.step1': 'Paso 1 de 4', 'guide.searchTitle': 'Busca un lugar', 'guide.searchDescription': 'Encuentra y selecciona la costa, lago, ciudad o paisaje que quieres analizar.', 'guide.openSearch': 'Abrir búsqueda', 'guide.step2': 'Paso 2 de 4', 'guide.dateTitle': 'Elige una fecha de adquisición', 'guide.dateDescription': 'Abre Fechas y selecciona un día resaltado con imágenes satelitales disponibles.', 'guide.openDates': 'Abrir fechas', 'guide.step3': 'Paso 3 de 4', 'guide.indicatorTitle': 'Elige un indicador', 'guide.indicatorDescription': 'Selecciona un análisis del panel izquierdo. La demo permite 1 análisis por cada indicador y dirección IP en cada ventana móvil de 24 horas. Usar un indicador no consume otro. Color Natural, búsqueda y fecha no cuentan.', 'guide.step4': 'Paso 4 de 4', 'guide.readyTitle': 'Todo listo', 'guide.readyDescription': 'Tu indicador está aplicado. Explora el mapa o haz clic en un cuerpo de agua para inspeccionar el resultado.', 'guide.ready': 'Todo listo', 'guide.search': 'Buscar', 'guide.dates': 'Fechas', 'guide.indicators': 'Indicadores', 'guide.readyShort': 'Listo',
    'access.title': 'Acceso de desarrollador', 'access.description': 'Inicia sesión con la frase privada de desarrollador para ejecutar pruebas ilimitadas en este navegador.', 'access.passphrase': 'Frase de acceso de desarrollador', 'access.signIn': 'Activar pruebas ilimitadas', 'access.signOut': 'Cerrar sesión de desarrollador', 'access.active': 'Las pruebas ilimitadas de desarrollador están activas.', 'access.invalid': 'La frase es incorrecta o el acceso de desarrollador no está disponible.', 'access.close': 'Cerrar acceso de desarrollador',
    'limit.demoBadge': 'Demo · 1 análisis por indicador / 24 h por IP', 'limit.reached': 'Este indicador ya fue utilizado desde esta IP. Intenta nuevamente después de {time}.', 'limit.unavailable': 'No fue posible verificar la cuota de análisis. Intenta nuevamente.', 'loader.analysis': 'Analizando datos satelitales',
